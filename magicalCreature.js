...
let canvisit = true
if (visitorAge > 15) { canVisit = true}
if(visitorAge < 15) {  canVisit = false}
...
let zooSummary = creatureName " " + creatureDescription " " + isFriendly " " + visitorAge " " + canVisit = creature
